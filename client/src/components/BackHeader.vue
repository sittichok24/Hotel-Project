          ...
          <li class="nav-item active" v-if="isUserLoggedIn">
            <router-link class="nav-link" active-class="active" to="/blogs"
              ><span class="font2" style="color: #fff"
                ><i class="fas fa-boxes"></i> Edit Hotel </span
              ></router-link
            >
          </li>
          <li class="nav-item active" v-if="isUserLoggedIn">
            <router-link class="nav-link" active-class="active" to="/Users"
              ><span class="font2" style="color: #fff"
                ><i class="fas fa-user-friends"></i> User hotel </span
              ></router-link
            >
          </li>
          <li class="nav-item active" v-if="isUserLoggedIn">
            <router-link
              ...
              to="/back/status"
              ><span class="font2" style="color: #fff"
                ><i class="fas fa-list-ul"></i> Status rooms </span
              ></router-link
            >
          </li>
...
<style scoped>
.bg-light {
  background: linear-gradient( 45deg, #5e6472, #aed9e0, #b8f2e6, #faf3dd, #ffa69e);
  color: #fff !important;
}
</style>