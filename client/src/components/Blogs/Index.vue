<template>
  <div v-if="isUserLoggedIn && user.type == 'admin'">
    ...
    <div class="header">
      <h3><i class="fas fa-th-list"></i> All Roomse </h3>
    </div>
    <div class="container">
      <div class="blog-header">
        <div class="create-blog" style="width: 100%">
                ...
                <td width="30%" align="center">
                  <span class="badge badge-success" style="padding: 10px">
                    <div class="media" style="margin-top: 10px">
                      ...
                      <div class="media-body" style="text-indent: 1em">
                        <h4>ห้องทั้งหมด {{ results.length }} ห้อง</h4>
                      </div>
                    </div>
                  </span>
                </td>
                <td width="30%" align="center">
                  <span class="badge badge-danger" style="padding: 10px">
                    <div class="media" style="margin-top: 10px">
                      ...
                      <div class="media-body" style="text-indent: 1em">
                        <h4>จองทั้งหมด {{ borrows.length }} ห้อง</h4>
                      </div>
                    </div>
                  </span>
                </td>
          ...
          <form class="form-inline form-search">
            <p class="font2">ห้องทั้งหมด {{ results.length }} ห้อง</p>
            &nbsp;&nbsp;
      ...
      <transition-group name="fade">
        <div v-for="blog in blogs" v-bind:key="blog.id" class="blog-list">
          ...
          <div class="blog-info">
            <p>
              <span class="font2">เลขห้อง :</span> {{ blog.id }}<br />
              <span class="font2">ประเภทเตียง :</span> {{ blog.category }}<br />
              <span class="font2">สถานะ:</span> {{ blog.status }}<br />
              <span class="font2">วันที่เพิ่มห้อง:</span>
...
export default {
  ...
  methods: {
    ...
    async deleteBlog(blog) {
      try {
        let result = confirm("คุณต้องการลบห้องหรือไม่?");
        if (result) {
