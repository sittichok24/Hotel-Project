<template>
  <div>
    ...
    <div class="header">
       <h3><i class="fas fa-box-open"></i> เพิ่มเตียง </h3>
    </div>
    <div class="container-fluid">
      <div class="container">
        <div class="blog-wrapper">
          <h4><i class="fas fa-bed"></i> รายละเอียดเตียง</h4>
          <br />
          <span class="font2">
            <form v-on:submit.prevent="createBlog">
              <div class="form-group">
                <label for="exampleInputEmail1">เตียง</label>
                <div class="input-group mb-3">
                  ...
                  <input
                    ...
                    type="text"
                    class="form-control"
                    placeholder="ชื่อเตียง"
                    v-model="blog.title"
                  />
                </div>
              </div>
              <br />
              <label for="exampleInputEmail1">รูปห้อง</label>
              <div class="blog-tab">
               ...
               <label for="exampleInputEmail1">สถานะ</label>
                <div class="input-group mb-3">
                  ...
                  <select v-model="blog.status" required>
                    ...
                    <option value="ไม่ยืนยัน">ไม่ยืนยัน</option>
                  </select>
                </div>
              </div>
              <br />
