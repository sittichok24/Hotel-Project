    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <router-link class="navbar-brand" active-class="active" to="/front">
        <img
          ...
          loading="lazy"
        />
        <span class="font1">&nbsp;The Hotel Project</span>
      </router-link>
      <button
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active" v-if="isUserLoggedIn">
            <router-link
              ...
              to="/borrow/create"
              ><span class="font2" style="color: #fff"
                ><i class="fas fa-clipboard-list"></i> จองห้องพัก</span
              ></router-link
            >
          </li>
          <li class="nav-item active" v-if="isUserLoggedIn">
            <router-link
              ...
              to="/borrow/status"
              ><span class="font2" style="color: #fff"
                ><i class="fas fa-list-ul"></i> สถานะห้องทั้งหมด</span
              ></router-link
            >
          </li>
