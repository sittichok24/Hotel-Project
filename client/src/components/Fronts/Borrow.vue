    ...
    <div class="container-fluid">
      <div class="container">
        <div class="blog-wrapper">
          <h4><i class="far fa-clipboard"></i> Details</h4>
          <br />
          <span class="font2">
            <form v-on:submit.prevent="createBorrow">
              <div class="row">
                ...
                <div class="col">
                  <label for="input1">วันที่สมัครสมาชิค</label>
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1"
              ...
              <div class="row">
                <div class="col">
                  <label for="input1">Check In</label>
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1"
                        ><i class="far fa-calendar-alt"></i
                ...
                <div class="col">
                  <label for="input1">Check Out</label>
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1"
              ...
              <div class="row">
                <div class="col">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <select v-model="borrow.equipment" required>
                      <option disabled value="">จำนวนเตียง</option>
                ...
                <div class="col">
                  <label for="input1">จำนวนคน</label>
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1"
              ...
              >
                <div class="blog-tab"><h5>รายละเอียดการจอง</h5></div>
                <p class="font3" style="margin-top: 10px">
                  {{ borrow.equipment }} / จำนวนคน :  {{ borrow.number }} / Check In :
                  {{ borrow.dateLend }}   Check Out :
                  {{ borrow.dateReturn }}  
...
export default {
  ...
  methods: {
    async createBorrow() {
      try {
        alert("ทำรายการจองห้องสำเร็จเรียบร้อยแล้ว");
