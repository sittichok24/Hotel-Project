<template>
  <div>
    ...
    <div class="header">
      <h3><i class="fas fa-tasks"></i> Room details</h3>
    </div>
                    ...
                    <div class="col" align="left">
                      ...
                      <div class="input-group mb-3">
                        ...
                        <select v-model="borrow.status" required>
                          ...
                          <option value="pending review">รอยืนยัน</option>
                          <option value="approved">ยืนยัน</option>
                          <option value="disapproved">ไม่อนุญาติ</option>
                          <option value="return">คืนเเล้ว</option>
                        </select>
                      </div>
                    </div>
                    <br />
